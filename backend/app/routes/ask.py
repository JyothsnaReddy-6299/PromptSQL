...
def ask_question(
    ...
    try:
        ...
        from sqlalchemy import inspect #SQLAlchemy to securely connect to MySQL, easily save system data (users, history, logs) using Python classes, and safely execute the raw SQL strings generated by your AI.
