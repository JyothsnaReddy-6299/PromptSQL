...
import { Database, Lock, User, ArrowRight, Loader2, AlertCircle, CheckCircle2 } from "lucide-react";
...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Auto login by saving credentials returned
      ...
      // Clear any previous active dataset so they start fresh
    ...
    <div className="relative min-h-screen bg-[#070708] flex items-center justify-center overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md px-8 py-10 bg-[#0d0d11]/80 backdrop-blur-xl border border-white/[0.06] rounded-3xl shadow-2xl relative z-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-zinc-400 mt-1.5 font-sans">Start analyzing your datasets with SQL and AI</p>
        </div>
        ...
        {success && (
          <div className="mb-6 p-4 bg-emerald-500/10 border border-emerald-500/20 text-emerald-200 text-sm rounded-xl flex items-start gap-3">
